      ...
      <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
          ...
          <div class="col-4 d-flex justify-content-end align-items-center">
            ...
            <!-- <a class="btn btn-sm btn-outline-secondary" href="#">Find a job</a> -->
          </div>
        </div>
      </header>
...
<?php if(is_front_page()) { ?>
  <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
        <div class="col-md-6 px-0">
          <h1 class="display-4 font-italic">Life in Europe</h1>
          <p class="p-3"></p>
          <p class="lead my-3">Learn about living and working in Europe as a third country national or foreigner</p>
        </div>
      </div>
    </div>
<?php } ?>
